...
<main class="main-content-inner">
    ...
    <div class="pull-right">
        ...
        <button class="btn btn-rev" title="Xóa bài viết" id="btnDelete" disabled data-toggle="tooltip" onclick="warningBeforeDelete()">
...
<%--                                                            &lt;%&ndash;<spring:message code="label.search.value"/>&ndash;%&gt;--%>
<%--                                                        Giá trị cần tìm--%>
<%--                                                    </label>--%>
<%--                                                    <div class="col-sm-8">--%>
<%--                                                        <div class="fg-line">--%>
...
<%--                                               data-toggle="tooltip"--%>
<%--                                                &lt;%&ndash;title='<spring:message code="label.user.add"/>'&ndash;%&gt;--%>
